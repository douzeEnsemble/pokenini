...
final class Version20250102063649 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE trainer_vote (trainer_external_id VARCHAR(255) NOT NULL, election_slug VARCHAR(255) NOT NULL, winner_slug VARCHAR(255) NOT NULL, losers TEXT NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, id UUID NOT NULL, PRIMARY KEY(id))');
