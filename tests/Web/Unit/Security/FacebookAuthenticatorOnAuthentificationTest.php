...
class FacebookAuthenticatorOnAuthentificationTest extends TestCase
{
    public function testOnAuthenticationSuccessNotATrainer(): void
    {
        ...
        $authenticator = $this->getFacebookzonAuthenticator([
     ...
     * @param string[] $routes
     */
    private function getFacebookzonAuthenticator(
        array $routes = []
